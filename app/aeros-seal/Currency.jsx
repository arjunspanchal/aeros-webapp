...
// Display currency toggle for the public AeroSeal rate sheet. Machines are a
// single per-unit price (no FCL/DDP basis), so this is a slimmed-down version
// of the bagasse Currency context — currency only. Default INR (₹); USD is an
...
export function CurrencyProvider({ children, initialCurrency = "INR" }) {
      ...
      {[
        ...
        <button
          ...
          className={
            ...
            (currency === o.value ? "bg-ink-900 text-white" : "text-ink-600 hover:text-ink-900")
          }
        >
          {o.label}
        </button>
