...
// Mode-aware pricing copy for the bagasse rate sheet. The rate ladder shows
  ...
  if (rateMode === "ddp") {
    return (
      <p>
        ...
        FOB Nhava Sheva and export quotes available on request. Prices subject to change with
        sugarcane-pulp costs.
      </p>
    );
  }
  return (
    <p>
      ...
      landed quotes available on request. Prices subject to change with sugarcane-pulp costs.
    </p>
  );
}
