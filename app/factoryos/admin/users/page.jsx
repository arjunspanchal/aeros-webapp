  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="text-sm text-gray-500 mt-1 dark:text-gray-400">Customers, customer managers, factory managers, and factory executives. Admin login uses a password, not a user row.</p>
