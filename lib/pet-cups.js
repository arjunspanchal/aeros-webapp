...
// PET cups are made in two top diameters only — Ø92 and Ø98 — so only round
// lids of those diameters actually fit. Square lids and off-size rounds (62/75/
// 80/85/87/90/148mm) belong to other cup lines, and the 72/73mm lids are for
// the ICT range, not PET. We filter lids to these diameters before listing.
const PET_LID_DIAMETERS = new Set([92, 98]);
