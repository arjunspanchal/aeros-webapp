...
const USERS_SELECT =
  "id,email,name,company,country,phone,factoryos_role,calculator_role,rate_cards_role,hr_role," +
  "active,designation,margin_pct,margin_cups_pct,discount_pct," +
...
const PATCHABLE = new Set([
  ...
  "factoryosRole", "calculatorRole", "rateCardsRole", "hrRole", "active",
  "marginPct", "marginCupsPct", "discountPct",
  "preferredCurrency", "preferredUnit", "notes",
]);
...
const SESSION_INVALIDATING = new Set([
  "factoryos_role", "calculator_role", "rate_cards_role", "hr_role", "active",
]);
