...
const USERS_SELECT =
  "id,email,name,company,country,phone,factoryos_role,calculator_role,rate_cards_role," +
...
const PATCHABLE = new Set([
  ...
  "factoryosRole", "calculatorRole", "rateCardsRole", "active",
...
const SESSION_INVALIDATING = new Set([
  "factoryos_role", "calculator_role", "rate_cards_role", "active",
]);
