...
const LIST_SELECT =
  ...
  "sample_kit_components(id,master_product_id,description,quantity_per_kit,unit_price,sort_order)";
...
async function replaceComponents(kitId, components) {
  ...
  const rows = components
    ...
    .map((c, idx) => ({
      ...
      unit_price:        c.unit_price === "" || c.unit_price == null ? null : Number(c.unit_price),
      sort_order:        idx,
    }));
