...
export async function fetchInventory() {
  ...
  // Branded dead stock and other internal-only inventory is hidden from
  // the public catalog. Staff toggle the flag from /clearance/manage.
  const publicOnly = normalized.filter((item) => !item.isInternal);
  return deduplicateByName(publicOnly);
}
