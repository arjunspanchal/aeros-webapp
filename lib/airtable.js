...
export async function fetchInventory() {
  const items = await dbSelect("clearance_items", {
    select: "id,airtable_id,item_name,brand,category,stock_quantity,unit,case_pack,price,price_unit,description,specifications,status,clearance_item_photos(storage_path,sort_order)",
    order: "item_name.asc",
    range: "0-9999",
  });
