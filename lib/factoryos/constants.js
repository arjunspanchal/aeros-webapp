...
// Printing-process whitelist. Used by both the New Job form dropdown and
// the job-create / patch API guards. Empty string means "not yet decided",
// "NA" means "no printing on this job" — both are explicit "no printing"
// states that the form has always permitted. Audit M4 previously allowed
// any free-form string server-side.
export const PRINTING_TYPES = ["", "Flexo", "Offset", "NA"];
